# demo_teleport
archivos de configuración para **Teleport**. 
La carpeta `/docker` incluye los archivos para probar el escenario con Docker, y las carpetas node y server contiene los archivos para probarlo en máquinas virtuales Linux que recomienda Teleport(Ubuntu 16.04+, Debian 9+).
